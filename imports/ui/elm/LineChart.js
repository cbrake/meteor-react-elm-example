...
var $terezka$line_charts$LineChart$defaultConfig = F2(
	function (toX, toY) {
		return {
			area: $terezka$line_charts$LineChart$Area$default,
			container: $terezka$line_charts$LineChart$Container$default('line-chart-1'),
			...
			x: A3($terezka$line_charts$LineChart$Axis$default, 700, '', toX),
...
var $terezka$line_charts$LineChart$view = F2(
	function (toX, toY) {
